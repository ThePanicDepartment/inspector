...
/// <summary>
/// A base class for singleton panel components.
/// </summary>
/// <remarks>
/// Ensures that only one instance of the singleton is created.
/// </remarks>
/// <typeparam name="T">The type of the singleton.</typeparam>
public abstract class SingletonPanelComponent<T> : PanelComponent, IHotloadManaged
	where T : SingletonPanelComponent<T>, IHotloadManaged
{
	[SkipHotload] private static T? _instance;
	...
	public static T Instance
	{
		get
		{
			if ( _instance.IsValid() && !_instance.IsProxy )
				return _instance;
